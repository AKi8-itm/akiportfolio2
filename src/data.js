...
export const aboutData = {
  ...
  paragraphThree: '上記のように、私には計画力とその計画の実行力、行動力があります。現在は、労働環境が劣悪な教職の道に進むのをためらっており、将来の選択肢を増やすために就職活動を始めています。色々なキャリアについて教えていただけたら嬉しいです。もしよろしければ、私までご連絡ください。以上です。ここまで読んでいただき、ありがとうございました。',
...
export const projectsData = [
  ...
  },
  {
    ...
    img: 'project.jpg',
    title: '私の特徴・趣味',
    info: '私には計画力や実行力・行動力がありますが、私の特筆すべき能力は、計画や実行を行うための情報収集能力です。IELTS 6.0の英語力を利用して英語圏の情報源から情報を入手できます。そして、SNSやインターネット上の断片的な情報同士を結び付けて有用な情報を取得することもできます。 たとえば、私はプログラミングの経験が一切ありませんでしたが、情報収集を行ってこのGatesbyjsを利用した静的サイトを作成することができました。加えて、私は小学校で3年以上アルバイトをしており、子どもたちと交流することや、理解しやすい方法で子どもたちに物事を教えるのことが得意です。',
  ...
  },
  {
    ...
    img: 'project.jpg',
    title: 'NPO法人ふらいおん"',
    info: '大学で得た教育分野の知識を活かして、20人以上の仲間たちと無料学習塾や非営利のプログラミング教室などを運営し、教育格差の是正や子どもの居場所づくりを行っています',
