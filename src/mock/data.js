...
export const projectsData = [
  {
    ...
    img: '1121.jpg',
    title: '私の経歴・職歴',
    info: '1998年6月14日生・大阪府池田市出身・私立雲雀丘学園高等学校卒・国立大学法人大阪教育大学初等教育教員養成課程小学校夜間5年コース在学中。小学校3年生の頃からフットサルを、小学校5年生の頃からサッカーを習い始め、高校卒業まで10年ほどサッカーをプレーし続けました。今は、時々フットサルをプレーしています。大学入学後は登山部に入部し、富士山や日本アルプス、屋久島の宮之浦岳などに登頂しています。',
    info2: '2018年から小学校で働き始め、現在は大阪市内の小学校でSSS（スクールサポートスタッフ）として、ICT機器整備などに携わっています。2020年からAmazonでの輸入販売ビジネス（現在休業中）や株式投資（2020年度は実現損益＋55％）、NPO法人の運営、Youtubeチャンネルやブログを始めました。',
    url: '',
